...
def прочитати_стан() -> dict:
    ...
    якщо_новий = {"date": "", "sent_ids": [], "total_found": 0, "scans": 0}
...
def main():
    ...
    if стан.get("date") != сьогодні:
        ...
        стан = {"date": сьогодні, "sent_ids": [], "total_found": 0, "scans": 0}
    ...
    # ── Фільтруємо нові (не надіслані раніше) ──
    нові_товари = [т for т in всі_товари if ід_товару(т) not in вже_надіслані]
    пропущені = нові_товари if номер_скану > 1 else []

    log.info("Нових (ще не надісланих): %d", len(нові_товари))
    ...
    for і, товар in enumerate(нові_товари, 1):
        ...
        нові_ід.append(ід_товару(товар))
